...
public final class MapBuilder {
	...
	private void addTestLights() {
		EntityBuilder.beginBuildingEntity(engine).addLightComponent(auxVector3_1.set(0.5f, 2f, 1.5f), 4f, 0.1f).finishAndAddToEngine();
//		EntityBuilder.beginBuildingEntity(engine).addLightComponent(auxVector3_1.set(3.5f, 2f, 4.5f), 2f, 0.9f).finishAndAddToEngine();
	}
